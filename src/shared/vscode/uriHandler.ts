...
export class UriHandler implements vscode.UriHandler {
    ...
    public async handleUri(uri: vscode.Uri): Promise<void> {
        ...
        if (!this.handlers.has(uri.path)) {
            await showViewLogsMessage(localize('AWS.uriHandler.nohandler', 'No handler for URI: {0}', uriNoQuery))
        ...
        try {
            ...
            await showViewLogsMessage(failedParsedMessage)
        ...
        try {
            ...
            await showViewLogsMessage(failedResolvedMessage)
